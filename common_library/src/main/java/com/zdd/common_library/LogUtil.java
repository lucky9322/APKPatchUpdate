...
package com.zdd.common_library;
...
public class LogUtil {
    public static final String TAG = "[XCLog070331]";
    ...
    public static void e(String tag, String content, Throwable exception) {
        log(ERROR, tag, content + android.util.Log.getStackTraceString(exception));
    }
